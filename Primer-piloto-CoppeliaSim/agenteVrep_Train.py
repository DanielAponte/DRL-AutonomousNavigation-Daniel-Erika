...
class Environment():   
    ...
    def __init__(self):
        ...
        self.dict_img = {
            (6.7, 6.7, 0) : '67_67_0.jpeg',
            (6.7, 6.7, 90) : '67_67_90.jpeg',
            (6.7, 5.2, 90) : '67_52_90.jpeg',
            (6.7, 5.2, 0) : '67_52_0.jpeg',
            (5.2, 5.2, 0) : '52_52_0.jpeg',
            (5.2, 5.2, 90) : '52_52_90.jpeg',
            (5.2, 3.8, 90) : '52_38_90.jpeg',
            (5.2, 3.8, 180) : '52_38_180.jpeg',
            (6.7, 3.8, 180): '67_38_180.jpeg',
            (6.7, 3.8, 90) : '67_38_90.jpeg',
            (6.7, 2.4, 90): '67_24_90.jpeg',
            (6.7, 2.4, 0) : '67_24_0.jpeg',
            (5.2, 2.4, 0) : '52_24_0.jpeg',
            (2.4, 2.4, 0) : '24_24_0.jpeg',
            (5.2, 5.2, 270) : '52_52_270.jpeg',
            (5.2, 6.7, 270) : '52_67_270.jpeg',
            (5.2, 6.7, 0) : '52_67_0.jpeg',
            (3.8, 6.7, 0) : '38_67_0.jpeg',
            (2.4, 6.7, 0) : '24_67_0.jpeg',
            (2.4, 6.7, 90) : '24_67_90.jpeg',
            (2.4, 5.2, 90) : '24_52_90.jpeg',
            (2.4, 3.8, 90) : '24_38_90.jpeg',
            (2.4, 3.8, 180) : '24_38_180.jpeg',
            (3.8, 3.8, 180) : '38_38_180.jpeg',
            (3.8, 3.8, 90) : '38_38_90.jpeg',
            (3.8, 2.4, 90) : '38_24_90.jpeg',
            (3.8, 2.4, 0) : '38_24_0.jpeg'
        }
    ...
    def get_screen_buffer(self):
        return np.array(Image.open(self.ModelPath + self.dict_img[self.routes[self.agent.route][self.agent.position]]).convert('RGB'))
...
env = Environment()
print(env.get_screen_buffer().shape)
