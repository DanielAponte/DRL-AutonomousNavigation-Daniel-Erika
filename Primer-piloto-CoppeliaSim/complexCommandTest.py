...
if clientID!=-1:
    ...
    emptyBuff = bytearray()
    errorCode,robotHandle=sim.simxGetObjectHandle(clientID,'Pioneer_p3dx',sim.simx_opmode_oneshot_wait)
    returnCode=sim.simxRemoveModel(clientID,robotHandle,sim.simx_opmode_oneshot_wait)
    returnCode,baseHandle=sim.simxLoadModel(clientID,'/home/daniel/Documents/Tesis/Mapas Vrep/Robot.ttm',1,sim.simx_opmode_blocking )
    errorCode,robotHandle=sim.simxGetObjectHandle(clientID,'Pioneer_p3dx',sim.simx_opmode_oneshot_wait)
